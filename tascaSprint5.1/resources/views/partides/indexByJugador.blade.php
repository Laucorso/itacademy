...
<div class ="">
    <div class ="mt-6 md:w-1/2 px-3 mb-6 md:mb-0">
        ...
        @csrf
            {{ Form::hidden('dau1', rand(1,6), array('id' => 'dau1')) }}
            {{ Form::hidden('dau2', rand(1,6), array('id' => 'dau2')) }}

            <input type ="hidden" value="{{ $dau1 = rand(1,6) }}" name = "dau1">
            <input type ="hidden" value="{{ $dau1 = rand(1,6) }}" name = "dau2">
